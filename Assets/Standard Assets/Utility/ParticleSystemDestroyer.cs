...
namespace UnityStandardAssets.Utility
{
     ...
     {
          // allows a particle system to exist for a specified duration, then shuts off emission, and
          // waits for all particles to expire before destroying the gameObject
